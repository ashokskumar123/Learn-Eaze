...
public class Eee_subjects extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eee_subjects);
        setTitle(" EEE Subjects ");
        ...
        ListView branches = (ListView) findViewById(R.id.eee_sub);
